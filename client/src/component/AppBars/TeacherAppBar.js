    ...
    <ThemeProvider theme={DrawerTheme}>
      <div className={classes.root} >
            ...
            <Toolbar variant={'dense'} className={classes.toolbar}>
              ...
              {props.searchPanel ? (
                ...
                <Typography component={"h1"}
                            style={props.detailLesson || props.lessonPage ? {position: 'absolute' , right: '45.8%'} : null }
                            align={'center'}
              ...
              {
                props.detailLesson ? (
                  <Button style={{position: 'absolute' , left: '2%'}} variant={'outlined'} color={'primary'}>
                    ویرایش
                  </Button>
                ) : ''
              }
        ...
        <Drawer variant={'permanent'} className={classes.drawer}>
          ...
          <ListItem button key={"کلاس ها"} className={classes.listItem}
