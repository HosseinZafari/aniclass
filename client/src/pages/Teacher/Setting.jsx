...
import { studentUpdate, teacherUpdate } from '../../apis/AuthApi'
...
const Setting = () =>  {
  ...
  const update = async (e) => {
    ...
    try {
      const result = await teacherUpdate(firstName , lastName ,  email , nationalCode , password)
      if(result.data && result.data.role === 'teacher') {
